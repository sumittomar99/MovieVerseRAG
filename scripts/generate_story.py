...
def generate_mixed_story(user_story, movie_descriptions, openai_api_key):
    ...
    Rules to follow:
    1. Title Name must be given with bold format and big in size,only title name should be there and add space before writing the title name,so it should be present in the centre of page.  
